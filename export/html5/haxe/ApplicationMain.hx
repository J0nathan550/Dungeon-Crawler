...
class ApplicationMain
{
	...
	{
		lime.system.System.__registerEntryPoint("Dungeon Crawler", create);

		#if (js && html5)
		#if (munit || utest)
		lime.system.System.embed("Dungeon Crawler", null, 640, 480);
		#end
		#else
		create(null);
		#end
	...
	public static function create(config):Void
	{
		...
		app.meta["file"] = "Dungeon Crawler";
		app.meta["name"] = "Dungeon Crawler";
